...
### 0.2.11 (Sep 17, 2014)
* CB-7249 documentation translation
...
* CB-7471 documentation translation
* CB-7551 **iOS 8** Scaled images show a white line
...
### 0.2.13 (Sep 17, 2014)
* CB-6374 Fix **iOS 6** deprecation warnings
...
* CB-7544 **iOS 8** Contact picker is read-only in iOS 8
* CB-7546 **iOS** `pickContact` shows exception in the console log
* Added documentation for manual tests
...
* CB-7538 Android beep thread fix Beep now executes in it's own thread
* Added documentation for manual tests
* Renamed test dir, added nested plugin.xml
...
### 0.3.1 (Sep 17, 2014)
* CB-6490 **BlackBerry10** Use `-` instead of `_` in `getLocaleName()`
* CB-6962 Ported globalization tests to framework
* CB-7064 Added tests that check for W3C compliance in language tags generated from `PreferredLanguage` and `GetLocale` methods
...
* CB-7133 **Android** Fix some tests
...
* CB-7471 Documentation translation
* CB-7490 **Windows** Fixes manual tests crash
